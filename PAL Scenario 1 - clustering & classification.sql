...
INSERT INTO PAL_KMEANS_PDATA_TBL VALUES (1, 'USER1', 'PAL_KMEANS_DATA_T', 'IN');
INSERT INTO PAL_KMEANS_PDATA_TBL VALUES (2, 'USER1', 'PAL_CONTROL_T', 'IN');
INSERT INTO PAL_KMEANS_PDATA_TBL VALUES (3, 'USER1', 'PAL_KMEANS_RESASSIGN_T', 'OUT');
INSERT INTO PAL_KMEANS_PDATA_TBL VALUES (4, 'USER1', 'PAL_KMEANS_CENTERS_T', 'OUT');

CALL SYS.AFLLANG_WRAPPER_PROCEDURE_DROP('USER1', 'PAL_KMEANS_PROC');
CALL SYS.AFLLANG_WRAPPER_PROCEDURE_CREATE('AFLPAL', 'KMEANS', 'USER1', 'PAL_KMEANS_PROC', PAL_KMEANS_PDATA_TBL);
...
CALL PAL_KMEANS_PROC(PAL_KMEANS_DATA_TBL, "#PAL_CONTROL_TBL", PAL_KMEANS_RESASSIGN_TBL, PAL_KMEANS_CENTERS_TBL) WITH OVERVIEW;
...
INSERT INTO PAL_CDT_PDATA_TBL VALUES (1, 'USER1', 'PAL_CDT_DATA_T', 'IN');
INSERT INTO PAL_CDT_PDATA_TBL VALUES (2, 'USER1', 'PAL_CONTROL_T', 'IN');
INSERT INTO PAL_CDT_PDATA_TBL VALUES (3, 'USER1', 'PAL_CDT_JSONMODEL_T', 'OUT');
INSERT INTO PAL_CDT_PDATA_TBL VALUES (4, 'USER1', 'PAL_CDT_PMMLMODEL_T', 'OUT');

CALL SYS.AFLLANG_WRAPPER_PROCEDURE_DROP('USER1', 'PAL_CREATEDT_PROC');
CALL SYS.AFLLANG_WRAPPER_PROCEDURE_CREATE('AFLPAL', 'CREATEDT', 'USER1', 'PAL_CREATEDT_PROC', PAL_CDT_PDATA_TBL);
...
CALL PAL_CREATEDT_PROC(PAL_KMEANS_RESULT_TBL, "#PAL_CONTROL_TBL", PAL_CDT_JSONMODEL_TBL, PAL_CDT_PMMLMODEL_TBL) WITH OVERVIEW;
...
INSERT INTO PAL_PCDT_PDATA_TBL VALUES (1, 'USER1', 'PAL_PCDT_DATA_T', 'IN');
INSERT INTO PAL_PCDT_PDATA_TBL VALUES (2, 'USER1', 'PAL_CONTROL_T', 'IN');
INSERT INTO PAL_PCDT_PDATA_TBL VALUES (3, 'USER1', 'PAL_PCDT_JSONMODEL_T', 'IN');
INSERT INTO PAL_PCDT_PDATA_TBL VALUES (4, 'USER1', 'PAL_PCDT_RESULT_T', 'OUT');

CALL SYS.AFLLANG_WRAPPER_PROCEDURE_DROP('USER1', 'PAL_PREDICTWITHDT_PROC');
CALL SYS.AFLLANG_WRAPPER_PROCEDURE_CREATE('AFLPAL', 'PREDICTWITHDT', 'USER1', 'PAL_PREDICTWITHDT_PROC', PAL_PCDT_PDATA_TBL);
...
CALL PAL_PREDICTWITHDT_PROC(PAL_PCDT_DATA_TBL, "#PAL_CONTROL_TBL", PAL_CDT_JSONMODEL_TBL, PAL_PCDT_RESULT_TBL) WITH OVERVIEW;
